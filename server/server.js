...
const normalizeGeneroValue = (value) => {
  ...
  if (['m', 'masculino', 'male', 'man', 'varon', 'varón'].includes(normalized)) return 'M';
  if (['f', 'femenino', 'female', 'woman', 'mujer', 'hembra'].includes(normalized)) return 'F';
...
app.post('/pacientes', async (req, res) => {
  ...
  try {
    ...
    const generoNormalizado = normalizeGeneroValue(genero);
